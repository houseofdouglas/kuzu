// Kuzu Spec Graph Schema
// Source of truth: this file
// Runtime DB: spec.db (derived — do not commit)
...
CREATE NODE TABLE IF NOT EXISTS Component(
    ...
    description STRING,
    status      STRING,   // proposed | active | deprecated | removed
    layer       STRING,   // storage | execution | catalog | api | extension | binding
    PRIMARY KEY (id)
);
...
// Feature fulfills a stated Requirement; Component validates another Component's behavior (e.g. test-infrastructure)
...
// Tracks active and completed merge requests (used by merge-coordinator)
CREATE NODE TABLE IF NOT EXISTS MergeRequest(
    branch_id       STRING,
